...
# We will just write a new MortgageSimulator.tsx that works.
...
import { Calculator, Save, TrendingUp, AlertCircle, ArrowLeft, Home, Zap, Clock, ShieldCheck, Sparkles, Bookmark, ArrowLeftRight, X } from 'lucide-react';
...
with open("src/components/MortgageSimulator.tsx", "w") as f:
    f.write(content)

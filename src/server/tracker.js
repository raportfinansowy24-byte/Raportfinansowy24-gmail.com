...
import { supabase, getIsSupabaseAvailable, setSupabaseUnreachable } from '../lib/supabase.js';
export async function trackClick(req, offer) {
...
export async function trackConversion(clickid, payout) {
    if (!getIsSupabaseAvailable()) {
        return;
    }
    try {
